...
#import "ICEkycBaseView.h"

#import "UIView+ICEkycViewController.h"
...
@protocol ICEkycPagerViewDelegate <NSObject>
@optional
/**
...
@interface ICEkycPagerView : UIView
/**
 *  PagerView init method.
 *
 *  @param frame PagerView show style.
 *  @param titles         Titles in Toptab.
 *  @param childVCs       Controllers or views in PagerView.
 *
 */
...
/**
 *  Reload PagerView with updated titles and viewcontrollers or views.
 *
 @param updatedTitles   update titles.
 @param updatedObjects      update viewcontrollers and views.
 */
...
@property (weak, nonatomic) id<ICEkycPagerViewDelegate>delegate; /**< PagerView代理 **/
